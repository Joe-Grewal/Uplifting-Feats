    ...
    <>
      <div className="outer_login_container">
        ...
        <div className="login_marketing_message">
          <p>Have you struggled to achieve your health goals? You are not alone. This is a non-judgemental space where you can seek out inspriation and insights from those who are similar to you in terms of their current health status, future health goals, diet and preferred workout regime. Perhaps you'll even inspire others on their own journey.</p>
        </div>
